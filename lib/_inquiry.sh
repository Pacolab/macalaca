...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do whasapo que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador whasapo, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar whasapo\n"
  printf "   [1] Atualizar whasapo\n"
  printf "   [2] Deletar whasapo\n"
  printf "   [3] Bloquear whasapo\n"
  printf "   [4] Desbloquear whasapo\n"
  printf "   [5] Alter. dominio whasapo\n"
  printf "\n"
  read -p "> " option
